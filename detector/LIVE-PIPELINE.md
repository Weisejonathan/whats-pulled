...
have been removed. Legacy detector write endpoints return HTTP 410. Only the
unified observation review queue can publish detected cards. Historical records
remain intact. Optional AI review is part of this same pipeline.
...
has 37 passing detector tests, including real OpenCV,
