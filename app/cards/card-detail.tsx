...
export type CardQuery = { copy?: string; favoriteSaved?: string; bidSubmitted?: string; claimRequested?: string; pullSubmitted?: string };
...
export function CardDetail({ detail, query, isLoggedIn, user, header }: { detail: CardCatalogDetail; query: CardQuery; isLoggedIn: boolean; user: { displayName: string } | null; header: ReactNode }) {
