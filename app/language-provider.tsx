...
const german: Record<string, string> = {
  ...
  "Latest detected card": "Zuletzt erkannte Karte",
  "Reading now": "Wird gerade gelesen",
  "Waiting for a card": "Warte auf eine Karte",
  "Reading name…": "Name wird gelesen…",
  "Not read yet": "Noch nicht erkannt",
  "Not readable / not visible": "Nicht lesbar / nicht sichtbar",
  "needs visual review": "Sichtprüfung nötig",
  "yes": "ja",
  "no": "nein",
  "Settings & help": "Einstellungen & Hilfe",
  "Suggestions": "Vorschläge",
  "Approve": "Bestätigen",
  "Reading details": "Erkennungsdetails",
  "Start capture and select the video tab. Detected fields will appear here.": "Starte die Aufnahme und wähle den Video-Tab. Erkannte Angaben erscheinen hier.",
  "Uploads are being retried. Recognition resumes when space is available.": "Uploads werden wiederholt. Sobald Platz frei ist, läuft die Erkennung weiter.",
  "Card is moving. Hold it steady briefly or use Capture now.": "Die Karte bewegt sich. Halte sie kurz ruhig oder nutze Jetzt aufnehmen.",
  "This card has been read. Show the next card or use Capture now to retry.": "Diese Karte wurde gelesen. Zeige die nächste Karte oder nutze Jetzt aufnehmen.",
  "Image is too dark, blurred or reflective. Adjust the focus area or use Capture now.": "Das Bild ist zu dunkel, unscharf oder spiegelt. Passe den Erkennungsbereich an oder nutze Jetzt aufnehmen.",
  "Looking for a readable card…": "Suche nach einer lesbaren Karte…",
  "Reading the card…": "Karte wird gelesen…",
  "Waiting for video frames…": "Warte auf Videobilder…",
  "Card read. Check the detected fields below.": "Karte gelesen. Prüfe die erkannten Angaben unten.",
  "Capture stopped. The last reading is retained.": "Aufnahme gestoppt. Das letzte Ergebnis bleibt erhalten.",
